...
def test_v14g5_runtime_bootstrap_is_synchronous_and_desktop_safe():
    ...
    assert 'import "./investment-panel.js?v=0.4.0-r42";' in panel
    assert 'const Panel = customElements.get("investment-panel-r42")' in panel
...
def test_base_panel_uses_fresh_versioned_custom_element_for_mobile_webview_upgrade():
    ...
    assert 'if(!customElements.get("investment-panel-r42")) customElements.define("investment-panel-r42",InvestmentPanel);' in panel
