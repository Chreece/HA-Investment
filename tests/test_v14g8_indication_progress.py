...
def test_v14g8_uses_fresh_progress_panel_identity():
    ...
    assert 'import "./investment-panel.js?v=0.4.0-r40";' in runtime
    assert 'const Panel = customElements.get("investment-panel-r40")' in runtime
    assert 'customElements.define("investment-panel-r40",InvestmentPanel)' in panel
